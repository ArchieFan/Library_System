<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookinventory.aspx.cs" Inherits="aspnetwebapp.adminbookinventory" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <%--<img width="100" src="images/imgs/books.png" />--%>
                                    <img id="imgview" width="100" src="images/imgs/books1.png" />
                                </center>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row p-2">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:TextBox CssClass="form-control" ID="TextBox10" runat="server" placeholder="Book Cost(per unit)" TextMode="Number" step="0.01"></asp:TextBox>
                            </div>
                            <div class="col-md-4">
                                <label>Pages</label>
                        ...
                        <div class="row p-2">
                            <div class="col-md-4">
                                ...
                                <asp:TextBox CssClass="form-control" ID="TextBox4" runat="server" placeholder="Actual Stock" TextMode="Number" Text="0"></asp:TextBox>
                            </div>
                            <div class="col-md-4">
                                <label>Current Stock</label>
                                <asp:TextBox CssClass="form-control" ID="TextBox5" runat="server" placeholder="Book Cost(per unit)" TextMode="Number" ReadOnly="True" Text="0"></asp:TextBox>
                            </div>
                            <div class="col-md-4">
                                <label>Sold Books</label>
                                <asp:TextBox CssClass="form-control" ID="TextBox7" runat="server" placeholder="Pages" TextMode="Number" ReadOnly="True" Text="0"></asp:TextBox>
                            </div>
                        </div>
                        <div class="row p-2">
                            <div class="col-12">
            ...
            <div class="col-md-7">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:eBookStoreDBConnectionString %>" SelectCommand="exec dbo.sp_getbooklist "></asp:SqlDataSource>
                            <div class="col">
